...
<body>
	...
	<section class="main">
		<div class="wrapp">
			<div class="mensaje">
				<h1>Bienvenidos Al Formulario De Reo Del Cereso</h1>
			</div>

    
                   <center><p> Bienvenido Al Formulario Reo.<p>
                    <center><p>Ingrese los datos que se piden<p>
	
                        <style>
		body{font-family: Arial; background-color: #5DADE2; box-sizing: border-box;}
...
<body>
	<form action="">
		...
		<p>¿Tiene Enfermedades? Si es si indique cuales.</p>
		<input type="text" class="field"> <br/>
